        ...
        <div className="relative w-full min-h-[150vh] max-w-[1600px] mx-auto pb-[300px] max-md:min-h-auto max-md:pb-0">
          {recommendedRoutes.map((route, index) => {
            ...
            return (
              ...
              >
                <div className="flex gap-5 mb-4 max-w-full overflow-hidden w-full flex-shrink-1 min-h-0 items-start max-md:gap-4 max-sm:gap-3 max-sm:mb-3">
                  <div className="flex-shrink-0 w-[140px] h-[140px] min-w-[140px] min-h-[140px] max-md:w-[120px] max-md:h-[120px] max-md:min-w-[120px] max-md:min-h-[120px] max-sm:w-[100px] max-sm:h-[100px] max-sm:min-w-[100px] max-sm:min-h-[100px] rounded-2xl overflow-hidden border-[3px] border-[#B0D4E8] box-border shadow-[0_8px_24px_rgba(0,0,0,0.2),0_4px_12px_rgba(0,0,0,0.15)] transition-all duration-400 relative group hover:scale-105 hover:shadow-[0_12px_32px_rgba(0,0,0,0.25),0_6px_16px_rgba(0,0,0,0.2)] max-md:rounded-xl max-sm:rounded-lg max-sm:border-2">
                    <img 
                  ...
                  <div className="flex-1 flex flex-col gap-1.5 min-w-0 max-w-full overflow-hidden flex-shrink-1 min-h-0 break-words overflow-wrap-break-word max-sm:gap-1">
                    <h3 className="text-[22px] max-md:text-[20px] max-sm:text-[18px] font-bold text-[#1a1a1a] m-0 mb-2 max-sm:mb-1.5 tracking-[-0.02em] break-words overflow-wrap-break-word max-w-full leading-[1.3] drop-shadow-[0_1px_2px_rgba(0,0,0,0.02)]">
                      {route.name}
                    </h3>
                    <p className="text-sm max-md:text-[13px] max-sm:text-xs font-normal text-[#333333] m-0 leading-[1.5] max-sm:leading-[1.4] break-words overflow-wrap-break-word max-w-full overflow-hidden line-clamp-4 max-sm:line-clamp-3 flex-shrink-1 tracking-[0.01em]">
                      {route.description}
                    </p>
                  </div>
                </div>
