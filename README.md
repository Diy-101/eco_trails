...
- Все статические ресурсы (изображения, иконки) должны находиться в папке `public/`
- Файлы из папки `public/` автоматически копируются в корень `dist/` при билде
- Пути к ресурсам обрабатываются автоматически с учетом base URL для GitHub Pages
